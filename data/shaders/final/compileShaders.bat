C:\VulkanSDK\1.2.148.0\Bin\glslangValidator.exe -V shadow.vert -o spirv\shadow.vert.spv
...
C:\VulkanSDK\1.2.148.0\Bin\glslangValidator.exe -V particle.frag -o spirv\particle.frag.spv
C:\VulkanSDK\1.2.148.0\Bin\glslangValidator.exe -V particlePoint.frag -o spirv\particlePoint.frag.spv
...
C:\VulkanSDK\1.2.148.0\Bin\glslangValidator.exe -V blur.frag -o spirv\blur.frag.spv
