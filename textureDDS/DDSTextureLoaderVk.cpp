...
namespace
{
    ...
    PFN_vkSetDebugUtilsObjectNameEXT vkSetDebugUtilsObjectNameEXTFunc = nullptr;
    ...
    inline void SetDebugObjectName(VkDevice device, VkImage image, const char(&name)[TNameLength]) noexcept
    {
            ...
            if(vkSetDebugUtilsObjectNameEXTFunc != nullptr)
            {
                vkSetDebugUtilsObjectNameEXTFunc(device, &debugObjectNameInfo);
            }
        #else
    ...
    {
        vkSetDebugUtilsObjectNameEXTFunc = funcPtr;
    }
    ...
    void DDSTextureLoaderVk::SetVkSetDebugUtilsObjectNameFuncPtrWithUserPtr(DDSTextureLoaderVk::PFN_DdsLoader_vkSetDebugUtilsObjectNameUserPtr funcPtr)
    {
        ...
        vkSetDebugUtilsObjectNameEXTFunc = [](VkDevice device, const VkDebugUtilsObjectNameInfoEXT* pNameInfo)
        {
