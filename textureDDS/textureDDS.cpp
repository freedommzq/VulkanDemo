...
public:
	...
	void preparePipeline() {
		...
		shaderStages[0] = loadShader(getShadersPath() + "textureDDS/textureDDS.vert.spv", VK_SHADER_STAGE_VERTEX_BIT);
		shaderStages[1] = loadShader(getShadersPath() + "textureDDS/textureDDS.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
